...
public class BusinessOperator {
	...
	public void deleteWindowFromBusiness(Business business, int i)
		...
		if (0 == window.getNo())// 业务中无该窗口
			...
			throw new DeleteTheOnlyWindowException("deleteWindowFromBusiness: No such a window in business "
							+ business.getName());
		}
		else {// 业务中有该窗口，删掉
	...
	//修改指定号码的窗口号
	public void modifyWindow(Business business,int sourceNo, int destNo) throws DispatchedWindowException {
